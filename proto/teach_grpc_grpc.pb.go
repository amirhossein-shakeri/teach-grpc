...
func (c *greeterClient) Health(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthReply, error) {
	out := new(HealthReply)
	err := c.cc.Invoke(ctx, "/pb.Greeter/Health", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGreeterServer) Health(context.Context, *HealthRequest) (*HealthReply, error) {
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/teach_grpc.proto",
}
